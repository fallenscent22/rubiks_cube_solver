from Rubiks_Cube_Solver import cube_model
...
if __name__ == '__main__':
    ...
    orig = cube_model.Cube("OOOOOOOOOYYYWWWGGGBBBYYYWWWGGGBBBYYYWWWGGGBBBRRRRRRRRR")
    c, d = cube_model.Cube(orig), cube_model.Cube(orig)
